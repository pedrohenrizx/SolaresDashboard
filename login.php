        ...
        <form id="login-form" class="space-y-6">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" onclick="alert('Password recovery mock!')" class="text-xs font-medium text-primary hover:text-blue-500">Forgot password?</a>
                </div>
                <input type="password" id="password" required class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary focus:invalid:border-red-500 focus:invalid:ring-red-500 dark:bg-gray-700 dark:text-white">
            </div>
